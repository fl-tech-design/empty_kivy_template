...
class Pop_Info(Popup):
    ...
    def __init__(self, **kwargs):
        ...
        self.title = let_up_first(self.app.base_txt["information"])
    ...
    def adjust_size(self, *args):
        ...
        text_height = label.texture_size[1] *0.8


        # Popup-Größe berechnen
        self.width = text_width + dp(20)  # 20dp Padding links/rechts
        self.height = text_height + dp(10)  # Label-Höhe

        # Sicherheitsminima
        self.width = max(self.width, dp(400))
        self.height = max(self.height, dp(50))
